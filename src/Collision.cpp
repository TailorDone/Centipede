...
bool Collision::BulletCollisionTest(const sf::Shape& Object1, const sf::Shape& Object2) {
...
bool Collision::MushroomCollisionTest(const sf::Shape& Object1, const sf::Shape& Object2) {
 
    sf::Vector2f A, B, C, BL, TR;
      sf::Vector2f HalfSize1 = {24 , 24};
      sf::Vector2f HalfSize2 = {24 , 24};
      //Normalise the Center of Object2 so its axis aligned an represented in
      //relation to Object 1
      C = Object1.getPosition();
      C -= Object2.getPosition();
